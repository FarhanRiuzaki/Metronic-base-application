...
<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
    ...
    @if (config('layout.extras.chat.display') == true)
        ...
        <li class="nav-item" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="Chat" data-placement="left">
            <a class="btn btn-sm btn-icon btn-bg-light btn-text-warning btn-hover-warning" href="#" data-toggle="modal" data-target="#kt_chat_modal">
                {{ Metronic::getSVG("media/svg/icons/Communication/Group-chat.svg", "svg-icon-md svg-icon-warning") }}
            </a>
        </li> 
    @endif
</ul>
